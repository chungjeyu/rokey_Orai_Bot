import cv2
import rclpy
import time  # 🔥 추가: 퍼블리시 딜레이용
from rclpy.node import Node
from sensor_msgs.msg import Image
from std_msgs.msg import String  # Bool 대신 String 임포트
...
class WebcamTriggerNode(Node):
    def __init__(self):
        ...
        # YOLO 모델 로드
        model_path = '/home/rokey/wc_last.pt'
        try:
    ...
    def run_logic(self):
        ...
        for cls in self.target_classes:
            ...
            if self.counters[cls] >= self.threshold and not self.latched[cls]:
                ...
                # 🔥 수정완료: 레이스 컨디션 방지 (이미지 먼저 전송 후 0.1초 대기)
